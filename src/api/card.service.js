...
export class CardService {
	 ...
	 *
	 * @param {number} amount The amount to be added or withdrawn from
	 * the user's balance.
	 * @param {'top-up'|'withdrawal'} type - The type of the transaction, either "top-up" or "withdrawal".
	 * @param {function} onSuccess - The callback function to be executed when the
	 * balance update is successful.
	 * @returns {Promise} A promise object that resolves to response from the API.
	 * */
	 ...
	 * @function
	 * @param {Object} body - The transfers details.
